                        ...
                        {#if aramaModu}
                            <div class="space-y-5" in:fade>
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <button type="button" onclick={baslatManuelArama} disabled={aramaYapiliyor} class="bg-(--accent) text-white px-6 rounded-xl font-black text-[10px] uppercase tracking-[0.2em] hover:shadow-[0_0_15px_var(--accent-glow)] transition-all active:scale-95 disabled:opacity-50 min-w-25 flex items-center justify-center">
